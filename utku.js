...
client.on("guildMemberAdd", async (member) => {
  ...
  ${Other.EmojiGeneral.Emoji6} • Soldaki \`Registrarion\` Odalarından Birine Geçerek Kaydolabilirsin.
  
  ${Other.EmojiGeneral.Emoji7} • Tagımızı Alarak \`${Settings.ServerSettings.Tagveetiket}\` Ailemizin Bir Parçası Olabilirsin.`)
  .setColor("RANDOM")
